...
public class VoicelineManager : Singleton<VoicelineManager>
{
    ...
    private Dictionary<string, EventReference> dialogueAudioEvents;
    ...
    private void Start()
    {
        ...
        dialogueAudioEvents = new()
        {
            ...
            {"Beebo_Alert2", AudioEvents.DialogueVO.beebo_alert},
            {"Beebo_FastestRoute1", AudioEvents.DialogueVO.beebo_fastest_route},
            {"Beebo_MsMariposa1", AudioEvents.DialogueVO.beebo_ms_mariposa},
            {"Beebo_OrderReceived1", AudioEvents.DialogueVO.beebo_order_received},
            {"Beebo_Processing1", AudioEvents.DialogueVO.beebo_processing},
            {"Beebo_Processing5", AudioEvents.DialogueVO.beebo_processing},
            {"Beebo_ReadyToGo1", AudioEvents.DialogueVO.beebo_ready_to_go},
            {"Beebo_Understood1", AudioEvents.DialogueVO.beebo_understood},
            {"Beebo_Understood2", AudioEvents.DialogueVO.beebo_understood},
            {"Beebo_Understood3", AudioEvents.DialogueVO.beebo_understood},
            {"Beebo_WhereToNext3", AudioEvents.DialogueVO.beebo_where_to_next},
